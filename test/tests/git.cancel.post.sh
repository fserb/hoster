...
$ lib/fetch PUT _git/test/b.txt "cancelled file"
OK

$ lib/fetch DELETE _git/test/a.txt
OK
...
$ lib/fetch GET _git/test # this should reset the working dir and undo all changes.
["a.txt"]
